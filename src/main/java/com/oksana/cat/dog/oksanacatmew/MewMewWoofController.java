...
public class MewMewWoofController {
    ...
    static {
        ...
        shos45.setName("(grass) Barley in flower");
        shos45.setType(Type.grass);
        shos45.setFEEDS(shos45.getName());
        shos45.setDM("");
        shos45.setME("10");
        shos45.setNEL((Double.parseDouble(shos45.getME()) * 0.6) + "");
        shos45.setCP("68");
        shos45.setFiber("316");
        shos45.setSugar("0");
        shos45.setFat("16");
        ...
        shos46.setName("(grass) Cabbage");
        shos46.setType(Type.grass);
        shos46.setFEEDS(shos46.getName());
        shos46.setDM("");
        shos46.setME("10.8");
        shos46.setNEL((Double.parseDouble(shos46.getME()) * 0.6) + "");
        shos46.setCP("160");
        shos46.setFiber("160");
        shos46.setSugar("320");
        shos46.setFat("47");
        ...
        shos47.setName("(grass) Clover red early flowering");
        shos47.setType(Type.grass);
        shos47.setFEEDS(shos47.getName());
        shos47.setDM("");
        shos47.setME("10.2");
        shos47.setNEL((Double.parseDouble(shos47.getME()) * 0.6) + "");
        shos47.setCP("179");
        shos47.setFiber("274");
        shos47.setSugar("0");
        shos47.setFat("37");
        ...
        shos48.setName("(grass) Clower white early flowering");
        shos48.setType(Type.grass);
        shos48.setFEEDS(shos48.getName());
        shos48.setDM("");
        shos48.setME("9");
        shos48.setNEL((Double.parseDouble(shos48.getME()) * 0.6) + "");
        shos48.setCP("237");
        shos48.setFiber("232");
        shos48.setSugar("84");
        shos48.setFat("42");
        ...
        shos49.setName("(grass) Grass young 75 80D");
        shos49.setType(Type.grass);
        shos49.setFEEDS(shos49.getName());
        shos49.setDM("");
        shos49.setME("12");
        shos49.setNEL((Double.parseDouble(shos49.getME()) * 0.6) + "");
        shos49.setCP("156");
        shos49.setFiber("130");
        shos49.setSugar("0");
        shos49.setFat("55");
        ...
        shos50.setName("(grass) Grass mature 60 65D");
        shos50.setType(Type.grass);
        shos50.setFEEDS(shos50.getName());
        shos50.setDM("");
        shos50.setME("10");
        shos50.setNEL((Double.parseDouble(shos50.getME()) * 0.6) + "");
        shos50.setCP("100");
        shos50.setFiber("200");
        shos50.setSugar("0");
        shos50.setFat("40");
        ...
        shos51.setName("(grass) Kale");
        shos51.setType(Type.grass);
        shos51.setFEEDS(shos51.getName());
        shos51.setDM("");
        shos51.setME("11");
        shos51.setNEL((Double.parseDouble(shos51.getME()) * 0.6) + "");
        shos51.setCP("157");
        shos51.setFiber("179");
        shos51.setSugar("284");
        shos51.setFat("36");
        ...
        shos52.setName("(grass) Lucerne early flowering");
        shos52.setType(Type.grass);
        shos52.setFEEDS(shos52.getName());
        shos52.setDM("");
        shos52.setME("8.2");
        shos52.setNEL((Double.parseDouble(shos52.getME()) * 0.6) + "");
        shos52.setCP("171");
        shos52.setFiber("300");
        shos52.setSugar("0");
        shos52.setFat("17");
        ...
        shos53.setName("(grass) Maize");
        shos53.setType(Type.grass);
        shos53.setFEEDS(shos53.getName());
        shos53.setDM("");
        shos53.setME("8.8");
        shos53.setNEL((Double.parseDouble(shos53.getME()) * 0.6) + "");
        shos53.setCP("89");
        shos53.setFiber("289");
        shos53.setSugar("0");
        shos53.setFat("26");
        ...
        shos54.setName("(grass) Rape");
        shos54.setType(Type.grass);
        shos54.setFEEDS(shos54.getName());
        shos54.setDM("");
        shos54.setME("9.5");
        shos54.setNEL((Double.parseDouble(shos54.getME()) * 0.6) + "");
        shos54.setCP("200");
        shos54.setFiber("250");
        shos54.setSugar("0");
        shos54.setFat("57");
        ...
        shos55.setName("(grass) Sugar beet tops");
        shos55.setType(Type.grass);
        shos55.setFEEDS(shos55.getName());
        shos55.setDM("");
        shos55.setME("9.9");
        shos55.setNEL((Double.parseDouble(shos55.getME()) * 0.6) + "");
        shos55.setCP("125");
        shos55.setFiber("100");
        shos55.setSugar("0");
        shos55.setFat("31");
        ...
        shos56.setName("(grass) Sugarcane");
        shos56.setType(Type.grass);
        shos56.setFEEDS(shos56.getName());
        shos56.setDM("");
        shos56.setME("8.9");
        shos56.setNEL((Double.parseDouble(shos56.getME()) * 0.6) + "");
        shos56.setCP("97");
        shos56.setFiber("312");
        shos56.setSugar("0");
        shos56.setFat("22");
        ...
        shos57.setName("(grass) Swede tops");
        shos57.setType(Type.grass);
        shos57.setFEEDS(shos57.getName());
        shos57.setDM("");
        shos57.setME("9.2");
        shos57.setNEL((Double.parseDouble(shos57.getME()) * 0.6) + "");
        shos57.setCP("192");
        shos57.setFiber("125");
        shos57.setSugar("0");
        shos57.setFat("42");
        ...
        shos58.setName("(roots) Artichoke Jerusalem");
        shos58.setType(Type.roots);
        shos58.setFEEDS(shos58.getName());
        shos58.setDM("");
        shos58.setME("13.2");
        shos58.setNEL((Double.parseDouble(shos58.getME()) * 0.6) + "");
        shos58.setCP("75");
        shos58.setFiber("35");
        shos58.setSugar("0");
        shos58.setFat("10");
        ...
        shos59.setName("(roots) Cassava");
        shos59.setType(Type.roots);
        shos59.setFEEDS(shos59.getName());
        shos59.setDM("");
        shos59.setME("12.8");
        shos59.setNEL((Double.parseDouble(shos59.getME()) * 0.6) + "");
        shos59.setCP("35");
        shos59.setFiber("43");
        shos59.setSugar("692");
        shos59.setFat("9");
        ...
        shos60.setName("(roots) Fodder beet");
        shos60.setType(Type.roots);
        shos60.setFEEDS(shos60.getName());
        shos60.setDM("");
        shos60.setME("11.9");
        shos60.setNEL((Double.parseDouble(shos60.getME()) * 0.6) + "");
        shos60.setCP("63");
        shos60.setFiber("56");
        shos60.setSugar("660");
        shos60.setFat("3");
        ...
        shos61.setName("(roots) Mangels");
        shos61.setType(Type.roots);
        shos61.setFEEDS(shos61.getName());
        shos61.setDM("");
        shos61.setME("12.4");
        shos61.setNEL((Double.parseDouble(shos61.getME()) * 0.6) + "");
        shos61.setCP("83");
        shos61.setFiber("58");
        shos61.setSugar("0");
        shos61.setFat("8");
        ...
        shos62.setName("(roots) Potatoes");
        shos62.setType(Type.roots);
        shos62.setFEEDS(shos62.getName());
        shos62.setDM("");
        shos62.setME("12.5");
        shos62.setNEL((Double.parseDouble(shos62.getME()) * 0.6) + "");
        shos62.setCP("90");
        shos62.setFiber("38");
        shos62.setSugar("638");
        shos62.setFat("5");
        ...
        shos63.setName("(roots) Sugar beet palp dried");
        shos63.setType(Type.roots);
        shos63.setFEEDS(shos63.getName());
        shos63.setDM("");
        shos63.setME("12.7");
        shos63.setNEL((Double.parseDouble(shos63.getME()) * 0.6) + "");
        shos63.setCP("99");
        shos63.setFiber("203");
        shos63.setSugar("82");
        shos63.setFat("7");
        ...
        shos64.setName("(roots) Sugar beet palp dried molassed");
        shos64.setType(Type.roots);
        shos64.setFEEDS(shos64.getName());
        shos64.setDM("");
        shos64.setME("12.5");
        shos64.setNEL((Double.parseDouble(shos64.getME()) * 0.6) + "");
        shos64.setCP("110");
        shos64.setFiber("132");
        shos64.setSugar("300");
        shos64.setFat("4");
        ...
        shos65.setName("(roots) Sugar beet molasses");
        shos65.setType(Type.roots);
        shos65.setFEEDS(shos65.getName());
        shos65.setDM("");
        shos65.setME("12.9");
        shos65.setNEL((Double.parseDouble(shos65.getME()) * 0.6) + "");
        shos65.setCP("47");
        shos65.setFiber("0");
        shos65.setSugar("632");
        shos65.setFat("0");
        ...
        shos66.setName("(roots) Sugarcane molasses");
        shos66.setType(Type.roots);
        shos66.setFEEDS(shos66.getName());
        shos66.setDM("");
        shos66.setME("0");
        shos66.setNEL((Double.parseDouble(shos66.getME()) * 0.6) + "");
        shos66.setCP("55");
        shos66.setFiber("0");
        shos66.setSugar("657");
        shos66.setFat("4");
        ...
        shos67.setName("(roots) Swedes");
        shos67.setType(Type.roots);
        shos67.setFEEDS(shos67.getName());
        shos67.setDM("");
        shos67.setME("12.8");
        shos67.setNEL((Double.parseDouble(shos67.getME()) * 0.6) + "");
        shos67.setCP("108");
        shos67.setFiber("100");
        shos67.setSugar("587");
        shos67.setFat("17");
        ...
        shos68.setName("(roots) Sweet potatoes");
        shos68.setType(Type.roots);
        shos68.setFEEDS(shos68.getName());
        shos68.setDM("");
        shos68.setME("12.7");
        shos68.setNEL((Double.parseDouble(shos68.getME()) * 0.6) + "");
        shos68.setCP("39");
        shos68.setFiber("38");
        shos68.setSugar("0");
        shos68.setFat("16");
        ...
        shos69.setName("(roots) Turnips");
        shos69.setType(Type.roots);
        shos69.setFEEDS(shos69.getName());
        shos69.setDM("");
        shos69.setME("11.2");
        shos69.setNEL((Double.parseDouble(shos69.getME()) * 0.6) + "");
        shos69.setCP("122");
        shos69.setFiber("111");
        shos69.setSugar("0");
        shos69.setFat("22");
